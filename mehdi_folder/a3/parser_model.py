...
class ParserModel(nn.Module):
    ...
    def __init__(self, embeddings, n_features=36,
        ...
        # TODO implement without nn.Embeddings
        #self.embeddings = nn.Parameter(torch.tensor(embeddings))
        self.embeddings = nn.Embedding(embeddings.shape[0], self.embed_size)
        self.embeddings.weight = nn.Parameter(torch.tensor(embeddings))
        ...
        self.embed_to_hidden_weight = nn.Parameter(torch.zeros(self.hidden_size, self.n_features * self.embed_size))
    ...
    def embedding_lookup(self, w):
        ...
        # TODO implement without nn.Embeddings later
        x = self.embeddings(w)
...
#         print(f'size of tensor x is: {x.size()}')
#         print(f'size of tensor embed_to_hidden_weight is: {self.embed_to_hidden_weight.size()}')
#         print(f'size of tensor embed_to_hidden_bias is: {self.embed_to_hidden_bias.size()}')
        z = x @ self.embed_to_hidden_weight.t() + self.embed_to_hidden_bias
        h = F.relu(z)
        h = self.dropout(h)
